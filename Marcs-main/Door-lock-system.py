...
val = None
Ds = None
model = load_model('G:\My Videos\SUBLIMETEXT\Pameran\Marcs-main\mask\model8.h5')

face_clsfr=cv2.CascadeClassifier('G:\My Videos\SUBLIMETEXT\Pameran\Marcs-main\mask\haarcascade_frontalface_default.xml')
...
net = cv2.dnn.readNetFromCaffe('G:\My Videos\SUBLIMETEXT\Pameran\Marcs-main\mobilenet_ssd\MobileNetSSD_deploy.prototxt','G:\My Videos\SUBLIMETEXT\Pameran\Marcs-main\mobilenet_ssd\MobileNetSSD_deploy.caffemodel')
